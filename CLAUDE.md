...
- **Obfuscação parcial**: `--obfuscate` sem `--rar` é o fluxo recomendado em 2026. Estrutura interna fica protegida pelo `_deep_obfuscate_tree` (renomeia tudo) + reverso pelo NZB via `obfuscated_map`.
